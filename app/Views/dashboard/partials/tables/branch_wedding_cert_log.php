<div class="table-responsive">
    <table class="table datatable table-striped">
        ...
        <tbody>
            <?php if(isset($branch_marriage_certificates) && !empty($branch_marriage_certificates)): ?>
                <?php foreach($branch_marriage_certificates as $certificate): ?>
                    <tr>
                        <td >
            ...
            <?php else: ?>
                <tr>
                    <td colspan="7" class="text-center">
                        <div class="alert alert-warning">No marriage certificate is associated with this branch</div>
                    </td>
                </tr>
            <?php endif; ?>
