<div class="tab-pane fade show active" id="uncompleted" role="tabpanel" aria-labelledby="uncompleted-tab">
    ...
    <div class="table-responsive">
        <table class="table table-bordered datatable2 table-hover">
            ...
            <tbody>
                <?php if (empty($branch_divorce_certificates)): ?>
                    <tr>
                        <td colspan="7" class="text-center">
                            <div class="alert alert-warning">No Divorce Certificates found for this branch.</div>
                        </td>
                    </tr>
                <?php else: ?>
                    <?php foreach ($branch_divorce_certificates as $cert): ?>
                        <tr>
