<form action="/dashboard/branches/edit/<?= esc($branch['branchId']) ?>" method="post">
        ...
        <div class="col-md-6 form-group mb-3">
            ...
            <div class="input-group">
                ...
                <input type="text" name="branchName" id="branchName"
                    ...
                    value="<?= old('branchName', esc($branch['branchName'])) ?>" required>
        ...
        <div class="col-md-6 form-group mb-3">
            ...
            <div class="input-group">
                ...
                <select name="branchCounty" id="branchCounty"
                    ...
                    ?>
                        <option value="<?= esc($county) ?>"
                            <?= old('branchCounty', $branch['branchCounty']) == $county ? 'selected' : '' ?>>
                            <?= esc($county) ?>
                        </option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="col-md-6 form-group mb-3">
            ...
            <div class="input-group">
                ...
                <input type="text" name="branchCityOrTown" id="branchCityOrTown"
                    ...
                    value="<?= old('branchCityOrTown', esc($branch['branchCityOrTown'])) ?>" required>
        ...
        <div class="col-md-6 form-group mb-3">
            ...
            <div class="input-group">
                ...
                <input type="tel" name="branchContact" id="branchContact"
                    ...
                    value="<?= old('branchContact', esc($branch['branchContact'] ?? '')) ?>" required>
        ...
        <div class="col-md-6 form-group mb-3">
            ...
            <div class="input-group">
                ...
                <input type="email" name="branchEmail" id="branchEmail"
                    ...
                    value="<?= old('branchEmail', esc($branch['branchEmail'] ?? '')) ?>" required>
        ...
        <div class="col-md-6 form-group mb-3">
            ...
            <div class="input-group">
                ...
                <select name="isActive" id="isActive"
                    ...
                    <option value="1" <?= old('isActive', $branch['isActive'] ?? 1) == '1' ? 'selected' : '' ?>>Active</option>
                    <option value="0" <?= old('isActive', $branch['isActive'] ?? 1) == '0' ? 'selected' : '' ?>>Inactive</option>
                </select>
    ...
    <!-- Branch Code (Display Only) -->
    <div class="form-group mb-3">
        <label for="branchCode" class="form-label">Branch Code</label>
        <small class="form-text text-muted">Automatically generated (cannot be changed)</small>
        <div class="input-group">
            <span class="input-group-text"><i class="fas fa-qrcode"></i></span>
            <input type="text" class="form-control d-block" value="<?= esc($branch['branchCode'] ?? '') ?>" readonly>
        </div>
    </div>
