...
<div class="certificate-card">
    ...
    <div class="p-3">
        <div class="row text-center">
            <?php foreach (['SIGNA' => 'A', 'SIGNB' => 'B', 'SIGNC' => 'C'] as $key => $label): ?>
                <div class="col-md-4">
                    <div class="mb-3">
                        <div class="mb-2"><strong>Signatory <?= $label ?></strong></div>
                        <?php if (!empty($certificate[$key])): ?>
                            <img src="/uploads/users/signatures/<?= $certificate[$key] ?>" 
                                 class="img-fluid signature-img" 
                                 style="max-height: 60px; cursor: pointer;"
                                 data-toggle="popover"
                                 data-placement="top"
                                 data-signer-id="<?= $certificate[$key.'_id'] ?>"
