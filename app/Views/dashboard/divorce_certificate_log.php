...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-0 text-gray-800">Divorce Certificate Log</h1>
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?= $total_uncomplete_certificate + $total_complete_certificate ?>
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?= ($total_uncomplete_certificate + $total_complete_certificate) > 0
                                    ? round(($total_complete_certificate / ($total_uncomplete_certificate + $total_complete_certificate)) * 100)
                                    : 0 ?>%
                            </div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-danger">
                <i class="fas fa-heart-broken mr-2"></i>Divorce Certificate Records
            </h6>
        </div>
        <div class="card-body">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="pending" role="tabpanel">
                    <?php if (!empty($branch_uncomplete_certificate)): ?>
                            ...
                            <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <?php foreach($branch_uncomplete_certificate as $cert): ?>
                                        <tr>
                                            <td><strong>#<?= esc($cert['divorceCertId']) ?></strong></td>
                                            <td><?= esc($cert['divorceplaintiff']) ?></td>
                                            <td><?= esc($cert['divorcedefendant']) ?></td>
                    ...
                    <?php else: ?>
                        <div class="text-center py-5 text-gray-500">
                            ...
                            <p>No pending divorce certificates found.</p>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="tab-pane fade" id="completed" role="tabpanel">
                    <?php if (!empty($branch_complete_certificate)): ?>
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                    ...
                    <?php else: ?>
                        <div class="text-center py-5 text-gray-500">
                            ...
                            <p>No completed divorce certificates found.</p>
                        </div>
                    <?php endif; ?>
                </div>
