...
public function __construct()
    ...
    /*
    * METHOD TO LIST WEDDING CERTIFICATES
    */
...
/*
* METHOD TO PRINT WEDDING CERTIFICATE
*/
...
/*
* METHOD TO GET SIGNER DETAILS VIA AJAX
*/
...
public function allow_edit($cert_id)
{
    ...
    if($certificate["SIGNC"] != null){
        ...
        // clear the SIGNC field to allow edit
        $certificate["SIGNC"] = null; 
        $certificate['SIGNC_id'] = null; 
        $certificate['SIGNC_signedDate'] = null; 
        
        // clear the SIGNB field to allow edit
        $certificate["SIGNB"] = null;
        $certificate['SIGNB_id'] = null; 
        $certificate['SIGNB_signedDate'] = null;

        // clear the SIGNA field to allow edit
        $certificate["SIGNA"] = null;
        $certificate['SIGNA_id'] = null;
        $certificate['SIGNA_signedDate'] = null;
